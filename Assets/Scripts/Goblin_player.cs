...
public class Goblin_player : MonoBehaviour
{
    /*
    tags:
    ...
    */
    ...
    void OnTriggerEnter2D(Collider2D col){
        if (col.gameObject.tag == "Enemigo")   //detecta enemigo
        {
            Debug.Log("disparar");
    ...
    void invocar(){
        ...
        //GameObject flecha = Instantiate(npc_summons, transform.position, Quaternion.identity) as GameObject;
        //flecha.GetComponent<Proyectil_flecha>().init(3*apuntar);
